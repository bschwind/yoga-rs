 ...
 *
 * @generated SignedSource<<2f8abba70b88760decb3db9262ac940d>>
...
#[test]
fn test_wrap_with_min_cross_axis() {
    let mut config = Config::new();
...
#[test]
fn test_wrap_with_max_cross_axis() {
    let mut config = Config::new();
...
#[test]
fn test_nowrap_expands_flexline_box_to_min_cross() {
    let mut config = Config::new();

    let mut root = Node::new_with_config(&mut config);
    root.set_flex_direction(FlexDirection::Row);
    root.set_position_type(PositionType::Absolute);
    root.set_min_height(StyleUnit::Point(400_f32.into()));
...
#[test]
fn test_wrap_does_not_impose_min_cross_onto_single_flexline() {
    let mut config = Config::new();
