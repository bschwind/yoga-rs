 ...
 *
 * @generated SignedSource<<02c163331bd86585f7cbfa5d00e60544>>
...
fn test_percentage_flex_basis_cross_min_height() {
    ...
    let mut root_child0 = Node::new_with_config(&mut config);
    root_child0.set_flex_grow(1_f32);
    root_child0.set_min_height(StyleUnit::Percent(60_f32.into()));
    root.insert_child(&mut root_child0, 0);

    let mut root_child1 = Node::new_with_config(&mut config);
    root_child1.set_flex_grow(2_f32);
    root_child1.set_min_height(StyleUnit::Percent(10_f32.into()));
    root.insert_child(&mut root_child1, 1);
    root.calculate_layout(Undefined, Undefined, Direction::LTR);
    ...
    assert_eq!(200_f32, root_child1.get_layout_width());
    assert_eq!(80_f32, root_child1.get_layout_height());
...
#[test]
fn test_percent_of_minmax_main() {
    let mut config = Config::new();

    let mut root = Node::new_with_config(&mut config);
    root.set_flex_direction(FlexDirection::Row);
    root.set_position_type(PositionType::Absolute);
    root.set_min_width(StyleUnit::Point(60_f32.into()));
    root.set_max_width(StyleUnit::Point(60_f32.into()));
    root.set_height(StyleUnit::Point(50_f32.into()));
...
#[test]
#[ignore]
fn test_percent_of_min_main_multiple() {
    let mut config = Config::new();
    ...
    let mut root_child1 = Node::new_with_config(&mut config);
    root_child1.set_width(StyleUnit::Percent(50_f32.into()));
    root_child1.set_height(StyleUnit::Point(20_f32.into()));
    root.insert_child(&mut root_child1, 1);

    let mut root_child2 = Node::new_with_config(&mut config);
    root_child2.set_width(StyleUnit::Percent(50_f32.into()));
...
#[test]
fn test_percent_of_minmax_cross_stretched() {
    let mut config = Config::new();
...
#[test]
fn test_percent_absolute_of_minmax_cross_stretched() {
    let mut config = Config::new();
...
#[test]
fn test_percent_of_minmax_cross_unstretched() {
    let mut config = Config::new();
...
#[test]
#[ignore]
fn test_percent_of_min_cross_unstretched() {
    let mut config = Config::new();
...
#[test]
fn test_percent_of_max_cross_unstretched() {
    let mut config = Config::new();
